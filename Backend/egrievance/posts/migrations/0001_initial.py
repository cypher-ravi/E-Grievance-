    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Government', 'Government'), ('Private', 'Private')], max_length=50)),
            ],
            options={
                'verbose_name': 'Space',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_type', models.CharField(choices=[('Question', 'Question'), ('Answer', 'Answer')], max_length=50)),
                ...
                ('liked', models.ManyToManyField(blank=True, default='', related_name='likes', to='profiles.profile')),
